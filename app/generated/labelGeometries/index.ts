...
import * as juicy from "./juicy";
import * as crunchy from "./crunchy";
import * as buttery from "./buttery";
import * as savory from "./savory";
...
import * as highlyPalatable from "./highly-palatable";
import * as soup from "./soup";
import * as salad from "./salad";
import * as dadJams from "./dad-jams";
import * as hangs from "./hangs";
import * as vibes from "./vibes";
import * as humanSlop from "./human-slop";
import * as beatsByChase from "./beats-by-chase";
...
export const labelGeometries = {
  ...
  "juicy": { positions: juicy.positions, uvs: juicy.uvs, indices: juicy.indices, width: juicy.width, height: juicy.height },
  "crunchy": { positions: crunchy.positions, uvs: crunchy.uvs, indices: crunchy.indices, width: crunchy.width, height: crunchy.height },
  "buttery": { positions: buttery.positions, uvs: buttery.uvs, indices: buttery.indices, width: buttery.width, height: buttery.height },
  "savory": { positions: savory.positions, uvs: savory.uvs, indices: savory.indices, width: savory.width, height: savory.height },
  "tender": { positions: tender.positions, uvs: tender.uvs, indices: tender.indices, width: tender.width, height: tender.height },
  ...
  "highly-palatable": { positions: highlyPalatable.positions, uvs: highlyPalatable.uvs, indices: highlyPalatable.indices, width: highlyPalatable.width, height: highlyPalatable.height },
  "soup": { positions: soup.positions, uvs: soup.uvs, indices: soup.indices, width: soup.width, height: soup.height },
  "salad": { positions: salad.positions, uvs: salad.uvs, indices: salad.indices, width: salad.width, height: salad.height },
  "dad-jams": { positions: dadJams.positions, uvs: dadJams.uvs, indices: dadJams.indices, width: dadJams.width, height: dadJams.height },
  "hangs": { positions: hangs.positions, uvs: hangs.uvs, indices: hangs.indices, width: hangs.width, height: hangs.height },
  "vibes": { positions: vibes.positions, uvs: vibes.uvs, indices: vibes.indices, width: vibes.width, height: vibes.height },
  "human-slop": { positions: humanSlop.positions, uvs: humanSlop.uvs, indices: humanSlop.indices, width: humanSlop.width, height: humanSlop.height },
  "beats-by-chase": { positions: beatsByChase.positions, uvs: beatsByChase.uvs, indices: beatsByChase.indices, width: beatsByChase.width, height: beatsByChase.height },
  "noise": { positions: noise.positions, uvs: noise.uvs, indices: noise.indices, width: noise.width, height: noise.height },
